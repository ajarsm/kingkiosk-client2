...
# Test 3: Display multiple images in fullscreen carousel mode
echo -e "${BLUE}Test 3: Display multiple images in fullscreen carousel mode${NC}"
publish_command '{
  "command": "play_media",
  "type": "image", 
  "url": [
  ...
  "style": "fullscreen",
  "title": "Fullscreen Carousel Test"
}'

# Test 3: Test image auto-detection from URL
echo -e "${BLUE}Test 3: Test image type auto-detection from URL${NC}"
publish_command '{
  "command": "play_media",
...
# Test 4: Test carousel with multiple images
echo -e "${BLUE}Test 4: Test carousel with multiple images${NC}"
publish_command '{
  "command": "play_media",
  "type": "image", 
  "url": [
...
# Test 5: Test error handling with invalid image URL
echo -e "${BLUE}Test 5: Test error handling with invalid image URL${NC}"
publish_command '{
  "command": "play_media",
  "type": "image", 
...
# Test 6: Stop all media including images
echo -e "${BLUE}Test 6: Stop media command to close images${NC}"
publish_command '{
  "command": "stop_media"
}'
