...
class TranslucentNotificationIndicator extends StatefulWidget {
  ...
  @override
  State<TranslucentNotificationIndicator> createState() =>
      _TranslucentNotificationIndicatorState();
}

class _TranslucentNotificationIndicatorState
    extends State<TranslucentNotificationIndicator>
    ...
    return Positioned(
      ...
      child: Obx(() {
        ...
        return GestureDetector(
          ...
          behavior:
              HitTestBehavior.opaque, // Only detect taps on the visible area
